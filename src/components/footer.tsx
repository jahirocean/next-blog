        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Stay Up to Dater with the latest news and insiht from our blog.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/jahirocean"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Twitter"
              >
                <Icons.twitter className="h-6 w-6 text-gray-500 hover:text-gray-700 dark:hover:text-gray-700" />
              </a>
              <a
